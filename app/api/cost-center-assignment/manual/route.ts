...
const SELECT =
  ...
  "vendor,debit,credit,movement,cost_center_id,cost_center_status,assignment_origin,operational_pct,updated_at,cost_centers(name)";
...
type Row = {
  ...
  operational_pct: number; updated_at: string|null;
